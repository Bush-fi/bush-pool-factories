...
import { CowPoolFactory } from "../../../contracts/cow/CowPoolFactory.sol";
import { CowRouter } from "../../../contracts/cow/CowRouter.sol";
import { CowPool } from "../../../contracts/cow/CowPool.sol";
...
contract CowPoolContractsDeployer is BaseContractsDeployer {
    ...
    constructor() {
        ...
        if (vm.exists("artifacts/@bush.fi/v3-pool-cow/")) {
            artifactsRootDir = "artifacts/@bush.fi/v3-pool-cow/";
        }
    }

// Exact fixed-point port of Bush's FixedPriceLBPool.sol (pool-weighted/contracts/lbp/FixedPriceLBPool.sol): a
// constant-sum sale pool where one project token always costs `projectTokenRate` reserve tokens, only the project
// token can be bought, and only during the sale window. See pvt/math-check/README.md.

//! Exact fixed-point port of Bush's StableSurgeHook.sol + SurgeHookCommon.sol: a dynamic swap fee that rises
//! linearly once a swap pushes the pool's imbalance past a threshold, and a guard that blocks unbalanced liquidity
//! operations while surging. The pool itself is a plain StablePool, reused from bush-maths. See pvt/math-check/README.md.

//! Stable surge hook implementation

use bush_maths::common::errors::PoolError;
use bush_maths::common::maths::{complement_fixed, div_down_fixed, mul_down_fixed};
use bush_maths::common::pool_base::PoolBase;
use bush_maths::common::types::SwapKind::GivenIn;
use bush_maths::common::types::{AddLiquidityKind, RemoveLiquidityKind, SwapParams};
use bush_maths::hooks::types::{
...
use bush_maths::hooks::{DefaultHook, HookBase, HookConfig};
use bush_maths::pools::stable::stable_data::StableMutable;
use bush_maths::pools::stable::StablePool;
use alloy_primitives::U256;

pub use bush_maths::hooks::StableSurgeHookState;

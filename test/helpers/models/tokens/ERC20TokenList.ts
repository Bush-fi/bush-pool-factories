...
export default class ERC20TokenList {
  ...
  get DAI(): Promise<ERC20TestToken> {
    return this.findBySymbol('DAI');
  }

  get CDAI(): Promise<ERC20TestToken> {
    return this.findBySymbol('CDAI');
  }

  get MKR(): Promise<ERC20TestToken> {
    return this.findBySymbol('MKR');
  }

  get SNX(): Promise<ERC20TestToken> {
    return this.findBySymbol('SNX');
  }

  get BAT(): Promise<ERC20TestToken> {
    return this.findBySymbol('BAT');
  }

  get GRT(): Promise<ERC20TestToken> {

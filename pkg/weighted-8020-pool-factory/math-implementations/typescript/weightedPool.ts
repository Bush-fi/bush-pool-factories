// Exact fixed-point port of the pool deployed by weighted-8020-pool-factory: WeightedPool8020Factory deploys the same WeightedPool contract with weights fixed at 80% / 20%.
...
} from '@bush.fi/maths/weighted/weightedMath';

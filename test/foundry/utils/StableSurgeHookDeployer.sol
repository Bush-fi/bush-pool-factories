...
import { StableSurgeHook } from "../../../contracts/stable-surge/StableSurgeHook.sol";
import { StableSurgeHookMock } from "../../../contracts/test/StableSurgeHookMock.sol";
import { StableSurgePoolFactory } from "../../../contracts/stable-surge/StableSurgePoolFactory.sol";
...
contract StableSurgeHookDeployer is BaseContractsDeployer {
    ...
    constructor() {
        ...
        if (vm.exists("artifacts/@bush.fi/v3-pool-hooks/")) {
            artifactsRootDir = "artifacts/@bush.fi/v3-pool-hooks/";
        }
    }

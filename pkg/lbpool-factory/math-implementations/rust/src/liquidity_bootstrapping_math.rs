use bush_maths::common::constants::WAD;
use bush_maths::common::errors::PoolError;
use bush_maths::common::maths::{div_down_fixed, mul_down_fixed};
...
fn calculate_value_change_progress(
    ...
    if current_time >= end_time {
        return Ok(WAD); // Fully completed
    } else if current_time <= start_time {
        return Ok(U256::ZERO); // Not started
    }
